...
public enum Unite {
    ...
    BOUTEILLE("Bouteille(s) (75cl)", "volume", 750, false),
    ARBITRAIRE("Unité(s)", "arbitraire", 1, true),
    DOUZAINE("Douzaine(s)", "arbitraire", 12, false);
    ...
    private final int value;// Facteur de conversion entre unité convertibles (masse en gramme, volume en
                            // mL, arbitraire en 1 unité)
