...
public enum EspeceAnimal {
	...
	POULE(NomZone.POULAILLER, AnimalDimorphisme.differentForMaleAndFemale(NomRessource.OEUF_POULE, "Poule", CheminAsset.ANIMAL + "poule.png", null, "Coq", CheminAsset.ANIMAL + "coq.png"), TypeVehicule.TRACTEUR, 1),
