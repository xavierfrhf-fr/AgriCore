...
public enum EspeceAnimal {
	...
	CANNE(NomZone.POULAILLER, AnimalDimorphisme.differentForMaleAndFemale(NomRessource.OEUF_CANNE, "Canne", CheminAsset.ANIMAL + "canne.png", NomRessource.PLUME, "Canard",CheminAsset.ANIMAL + "canard.png"), TypeVehicule.TRACTEUR, 2),
