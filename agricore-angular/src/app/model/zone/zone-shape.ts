...
export class ZoneShape {
  ...
  getShapeHeightPx(cellSize: number): number {
    return this.getShapeHeight() * cellSize;
  }
  ...
  public static zoneShapeFromZoneDataDTO(zoneDataDTO: ZoneDataDTO): ZoneShape {
    console.log(zoneDataDTO.shape);
    return new ZoneShape(zoneDataDTO.shape, -1, -1, zoneDataDTO.pathSprite);
  }
}
